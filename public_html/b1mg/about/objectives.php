<?php
   $title = "The objectives and key results of the Beyond 1 Million Genomes (B1MG) project";
...
<section class="section pt-55">
    <div class="container content has-text-grey-darker">
        ...
        <p>The B1MG project has three main objectives. For an overview of the Work Packages (WPs) mentioned here, see the <a href="/b1mg/work-packages">Work Packages section</a>.</p>
        <h2 class="is-size-4">Objective 1: To work with regional, national and European stakeholders to define the requirements for cross-border access to genomics and personalised medicine data.</h2>
            <p>To define the requirements for cross-border access to genomics and personalised medicine data, B1MG will establish a <strong>Stakeholder Coordination Group (SGC)</strong> to gather input at regular intervals from all relevant stakeholders. These requirements will be fed into Objectives 2 and 3. The group will include national-level representatives from the 1+MG initiative and beyond, experts from the public and private sectors, policy-makers, and patients and citizens more generally. </p>
            ...
            <button class="accordion single-line" style="width: 100%;">Objective 1 key results</button>
        ...
        <h2 class="is-size-4 mt-6">Objective 2: To translate requirements for data quality, standards, technical infrastructure, and Ethical, Legal and Social Issues (ELSI) into technical specifications and implementation guidelines.</h2>
            ...
            <button class="accordion single-line" style="width: 100%;">Objective 2 key results</button>
            <div class="accordion-panel">
              <div>
        ...
        <h2 class="is-size-4 mt-6">Objective 3: To drive adoption of this new infrastructure and to support long-term its operation by organisations at local, regional, national and European level. It will do this by providing guidance on development, and ways to evaluate economic impact.</h2>
            ...
            <button class="accordion single-line" style="width: 100%;">Objective 3 key results</button>
            <div class="accordion-panel">
              <div>
                <ol>
