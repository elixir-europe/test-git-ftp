...
<section class="section pt-55">
    <div class="container content has-text-grey-darker">
        ...
        <div class="media grey px-3 pb-2 pt-3 my-55">
            ...
            <p class="media-content mt-2">Not sure what 'genotype' and 'phenotype' mean? See the <a href="/b1mg/about/guide-science">Simple guide to the science</a>. </p>
        </div>
        ...
        <p>For an overview of the Work Packages (WPs) mentioned here, see the <a href="/b1mg/work-packages">Work Packages section</a>.</p>
        ...
        <ul class="mt-0">
          <li><a href="/b1mg/about/how-organised">How the project is organised</a></li>
            <li><a href="/b1mg/about/basic-science">The science behind the project</a></li>
