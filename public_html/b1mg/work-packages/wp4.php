...
<section class="section pt-3">
    <div class="container content has-text-grey-darker">
        ...
        <tbody>
          <tr>
            <td>D4.1</td>
            <td><strong>Secure cross-border data access roadmap.</strong> <br />
        ...
        <div class="columns profiles">
          <div class="column">
            <figure>
              <img src="/b1mg/images/people/tommi-nyronen.jpg" alt="Ivo Gut" />
              <figcaption>Tommi Nyr&ouml;nen (CSC)</figcaption>
            </figure>
          </div>
          <div class="column">
            <figure>
              <img src="/b1mg/images/people/ilkka-lappalainen.jpg" alt="Ilkka Lappalainen" />
              <figcaption>Ilkka Lappalainen (CSC)</figcaption>
            </figure>
          </div>
          <div class="column">
            <figure>
              <img src="/b1mg/images/people/bengt-persson.jpg" alt="Bengt Persson" />
              <figcaption>Bengt Persson (Uppsala University)</figcaption>
            </figure>
          </div>
          <div class="column">
            <figure>
              <img src="/b1mg/images/people/sergei-beltran.jpg" alt="Sergei Beltran" />
              <figcaption>Sergei Beltran (CNAG-CRG)</figcaption>
            </figure>
          </div>
